...
#bbox=(11.60339,48.17708,11.61304,48.18326) ; size=(1500, 1000) # between Grasmeier and Crailsheimerstr.
bbox =(11.59221,48.17038,11.61233,48.18380) ; size=(2000, 2000)  # bigger as above.
...
patch_generator.generate_patches(bbox, size, 
    patch_size=48, 
    offset_steps=1,
    target_folder='../data/patchesB-48',
    force_refresh=False
)
