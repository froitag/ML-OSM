...
import os
from numpy import zeros,linalg,arccos,dot,argsort,concatenate
import pylab
...
def process_image(imagename, resultname):
    ...
    if os.name == "posix":
        cmmd = "./lib/sift/lowe/sift <"+imagename+">"+resultname
    else:
        cmmd = "lib\\sift\\lowe\\bin\\siftWin32 <"+imagename+">"+resultname
    
    os.system(cmmd)
    print 'processed', origname
